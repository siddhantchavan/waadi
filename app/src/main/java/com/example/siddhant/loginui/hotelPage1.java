...
public class hotelPage1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_page1);
        ...
        govilla=findViewById(R.id.go_hotel);
        destination=findViewById(R.id.hdestination);
        ...
        db=FirebaseDatabase.getInstance().getReference().child("hotels").child("Sheet1");
        db.keepSynced(true);
