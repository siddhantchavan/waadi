...
public class cab2 extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText name1,name, address1, mobileno1, rtobranch1, rtoaddress1, dateofregistration1,working1,username1,password1,location,cpassword1,email1,agencyname1,cno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if(chkBox3.isChecked()&&cno.getText().toString().trim().isEmpty())
                {
                    cno.setError("Cannot be empty");
                }else if(chkBox3.isChecked()&& rtobranch1.getText().toString().trim().isEmpty()){
                    rtobranch1.setError("cannot be empty");
                }else if(chkBox3.isChecked()&& address1.getText().toString().trim().isEmpty()){
                    address1.setError("cannot be empty");
                }else if(chkBox3.isChecked()&&dateofregistration1.getText().toString().trim().isEmpty()){
                    dateofregistration1.setError("cannot be empty");
                }else if(chkBox4.isChecked()&&agencyname1.getText().toString().trim().isEmpty()){
