...
public class hotelList extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    DatabaseReference reff;
    String near;
    String destination;
    static resortAdapter[] vAdapter=new resortAdapter[1];
    RecyclerView list;
    java.util.List<cardItems> List=new ArrayList<>();
    SeekBar seekBar;
    TextView seekbarop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setLayoutManager(new LinearLayoutManager(hotelList.this));
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot listsnapshot : dataSnapshot.getChildren()) {
                    ...
                    cardItems nd = new cardItems(mp.get("Name"), mp1.get("Price_per_night"), mp.get("img_url"),Double.parseDouble(mp2.get("Ratings")+""),mp.get("Location"),mp.get("Near"));
        ...
        vAdapter[0].setCardClickListener(new resortAdapter.onCardClick(){
            ...
            public void onCardClick(cardItems items) {
                cardItems mb=items;
                Intent i=new Intent(getApplicationContext(),hotel_desc.class);
                i.putExtra("hname",mb.getName());
                startActivity(i);
            }
        });
