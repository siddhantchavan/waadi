...
public class cab3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cab3);
        sbtn=findViewById(R.id.go_cab);
        t1=findViewById(R.id.src2);
        t2=findViewById(R.id.des1);
        ...
        sbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (src.equals(dest))
                {
                    ...
                    Toast.makeText(cab3.this,"source and Destination cannot be same",Toast.LENGTH_SHORT).show();
                }
                else{
                    if(!isNetworkAvailable()) {
                        Intent i = new Intent(getApplicationContext(), cab_list.class);
