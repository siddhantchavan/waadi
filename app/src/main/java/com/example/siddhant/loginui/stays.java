...
public class stays extends AppCompatActivity {
    ...
    Button hotel,resort,villa,homestays;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homestays=findViewById(R.id.homestay);


        hotel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),hotelPage1.class));
            }
        });
        resort.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),resortPage1.class));
            }
        });
        ...
        homestays.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
